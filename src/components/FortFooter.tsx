...
function FortFooter() {
  ...
  const copyrightStartYearEpic = 1991;
      ...
      <Container className='py-3 py-md-4'>
        <div className='d-md-flex justify-content-md-between align-items-md-center text-center text-md-start'>
          <div className='footer-copyright mb-3 mb-md-0'>
            All content & design © Fortnite, {copyrightStartYearDB}-{currentYear}.
            <br />
            Fortnite images & names © {copyrightStartYearEpic}-{currentYear} Epic Games.
