        ...
        <Row className="shadow-lg p-3 bg-body rounded">
          <Col lg={8} className="p-3">
            <p className="lead fs-6 lh-lg text-center">
              Tired of dropping at the same old named locations every match?
              Break the cycle and inject <strong>pure randomness</strong> into
              your Fortnite games with our{" "}
              <FontAwesomeIcon icon={faMapMarkerAlt} className="icon-spacer" />{" "}
              <FontAwesomeIcon icon={faDice} className="icon-spacer" />{" "}
              <strong>Random Drop Spot generator</strong>! Whether you&apos;re
              looking to explore forgotten corners of the map, challenge
              yourself with unfamiliar terrain, or simply let fate decide your
              starting point, one click is all it takes to get a completely
              random POI or landmark for your next jump. Ditch the routine,{" "}
              <strong>embrace the chaos</strong>, and discover your next
              favorite landing zone completely by chance!
            </p>
